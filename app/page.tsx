    ...
    <div className="px-6 max-w-6xl mx-auto">
      ...
      <section className="text-center mt-10 md:mt-20">
        <h1 className="text-5xl md:text-6xl font-extrabold leading-tight 
          ...
          bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(56,189,248,0.3)]"
        >
        ...
        <Link
          ...
          className="inline-block mt-10 px-8 py-3 rounded-xl 
            ...
            shadow-[0_0_20px_rgba(56,189,248,0.4)] hover:scale-105 
            transition-all"
        >
          Explore Workshops
        </Link>
      ...
      <section className="mt-32 grid md:grid-cols-3 gap-10">
        {[
          ...
          <div
            key={idx}
            className="p-6 bg-white/10 backdrop-blur-xl border border-white/10 
              rounded-2xl shadow-[0_0_30px_rgba(56,189,248,0.15)] hover:-translate-y-1 
              transition-all"
          >
